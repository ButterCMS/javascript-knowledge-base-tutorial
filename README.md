...
## Important Note
This project was created as an example use case of ButterCMS in conjunction with a blog article, [How to Build a Knowledge Base with JavaScript: A Comprehensive Tutorial Featuring ButterCMS](https://buttercms.com/blog/javascript-app-tutorial-knowledge-base-creation/), and will not be actively maintained.
